...
//   return (
//     <div class="card  shadow-xl w-96 mx-auto mt-10">
//       <div class="card-body">
...
//             </label>
//             <input type="text" name="name" value={formData().name} onInput={handleInputChange} placeholder="Enter full name" class="input input-bordered" required />
//           </div>
//           <div class="form-control">
//             <label class="label">
//               <span class="label-text">Age</span>
//             </label>
//             <input type="number" name="age" value={formData().age} onInput={handleInputChange} placeholder="Enter age" class="input input-bordered" required />
//           </div>
//           <div class="form-control">
//             <label class="label">
//               <span class="label-text">Gender</span>
//             </label>
//             <select name="gender" value={formData().gender} onInput={handleInputChange} class="select select-bordered" required>
...
//             </label>
//             <input type="tel" name="contact" value={formData().contact} onInput={handleInputChange} placeholder="Enter contact number" class="input input-bordered" required />
//           </div>
//           <div class="form-control">
//             <label class="label">
//               <span class="label-text">Address</span>
//             </label>
//             <textarea name="address" value={formData().address} onInput={handleInputChange} placeholder="Enter address" class="textarea textarea-bordered" required></textarea>
//           </div>
  ...
  return (
    <Motion.div animate={{ opacity: [0, 1] }} transition={{ duration: 1, easing: "ease-in-out" }} class="mx-auto p-8 bg-base-100/70 rounded-lg shadow-lg">
      ...
      {/* <div class="grid grid-cols-12 items-center">
        <h1 class="text-3xl font-bold text-center mb-6 col-span-3">Patient Entry Form - Create</h1>
        <PatientCard data={formData} />
      </div> */}
      {/* <div class="grid grid-cols-12 bg-red-400 w-full">
        <div class="col-span-8 text-3xl font-bold text-center mb-6 w-full ">Patient Entry Form - Create</div>
        <PatientCard data={formData} />
      </div> */}
      <div className="flex w-full">
        <div class="flex-1  text-3xl font-bold text-center mb-6 ">Patient Entry Form - Create</div>
        <div>
          <PatientCard data={formData} />
        </div>
      </div>
